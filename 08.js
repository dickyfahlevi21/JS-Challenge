class Str {
    ...
    slug(word, seperator = "-") {
        ...
        word = word.replace(/  +/g, " ");
        word = word.split(" ").join(seperator);
        return word;
    }
    // 8
    count(word) {
...
/*1*/
console.log(str.lower('DICKY'))
/*2*/
console.log(str.upper('dicky'))
/*3*/
console.log(str.capitalize("si kancil anak nakal"))
/*4*/
console.log(str.reverse("tes"))
/*5*/
//belum selesai
/*6*/
